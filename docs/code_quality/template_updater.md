...
steps:
  - script: |
      ...
      git read-tree --prefix=build/pipelines/repo_template/build/code_quality_templates/ -u repo_template/main:build/pipelines/code_quality_templates
...
* perform a git read-tree to see what is different between the contents of `build/pipelines/repo_template/build/code_quality_templates/` in this Repo and in the repo_template Repo
